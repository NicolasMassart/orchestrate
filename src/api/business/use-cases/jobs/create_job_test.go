...
func TestCreateJob_Execute(t *testing.T) {
	...
	t.Run("should execute use case successfully", func(t *testing.T) {
		...
		mockTransactionDA.EXPECT().Insert(gomock.Any(), jobEntity.Transaction).Return(jobEntity.Transaction, nil)
		// TODO: Improve test when RunInTransaction is moved to data layer
	...
	t.Run("should fail with same error if cannot insert a Transaction fails", func(t *testing.T) {
		...
		mockTransactionDA.EXPECT().Insert(gomock.Any(), jobEntity.Transaction).Return(nil, expectedErr)
