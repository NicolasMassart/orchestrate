...
import (
	...
	loader "github.com/consensys/orchestrate/pkg/handlers/loader/sarama"
	"github.com/consensys/orchestrate/pkg/handlers/offset"
...
func Start(ctx context.Context) error {
	...
	if err != nil {
		logger.WithError(err).Error("failed to parse test data")
		return err
	}
